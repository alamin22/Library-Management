  ...
  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 nopadding">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="row form-group">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                            <input type="text" value="{{$book_donators->book_donars_name}}" class="form-control" id="donator_name" name="donator_name">
                            <input type="hidden" value="{{$book_donators->book_donars_id}}" id="hidden_id" name="hidden_id">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                            <input type="text" value="{{$book_donators->book_donars_mobile}}" id="donator_phone" name="donator_phone" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12 mt-2"><level for="address">Address</label></div>
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
                            <input type="text" value="{{$book_donators->book_donars_address}}" name="address" id="address" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
       function insertBookDonator(){
            ...
            $.ajax({
                url:"{{route('library.updateDonatorsStore')}}",
                type:"POST",
